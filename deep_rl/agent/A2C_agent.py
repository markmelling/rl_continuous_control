    ...
    def step(self):
        ...
        for _ in range(config.rollout_length):
            ...
            storage.feed({'reward': tensor(rewards).unsqueeze(-1),
                          'mask': tensor(1 - np.array(terminals)).unsqueeze(-1)})
        ...
        # print('log_pi_a', entries.log_pi_a)
        # print('log_pi_a.shape', entries.log_pi_a.shape)
        # print('advantage', entries.advantage)
        # print('advantage.shape', entries.advantage.shape)
